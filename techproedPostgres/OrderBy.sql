-- ***** ORDER BY *****
-- ORDER BT cumlecigi bir SORGU deyimi icerisinde belli bir SUTUN'a gore
...
--Soru2 : kisiler tablosunu adres'e göre tersten sıralayarak sorgulayınız.
select * from kisiler order by adres desc -- DESCENDING (desc) --> tersten siralama yapar

--Soru3 : kisiler tablosunda maasi buyukten kucuge siralayin
select * from kisiler order by maas desc

--Soru4 : ismi Mine olanları, maas a göre AZALAN sırada sorgulayınız
select * from kisiler Where isim = 'Mine' order by maas desc  

--Soru5 : soyismi 'i Bulut olanları maas sıralı olarak sorgulayınız.
