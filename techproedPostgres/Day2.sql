...
insert into student(id,st_name) values ('1015','Mehmet Can');

--DQL --> Data Query Lang.
-- ******* SELECT *******
select * from student; // ogrenci listesini yazdirir
select st_name from student;// ogrenci listesindeki isimleri yazdirir
select age from student;// ogrenci listesindeki yaslari yazdirir


-- ******* SELECT KOMUTU WHERE KOŞULU *******
select * from student WHERE age>35;// 35 yasindan buyuk olanlari yazdirir
...
-- Soru 1: id'si 124 olan öğrenciyi siliniz
DELETE FROM ogrenciler WHERE id = 124;

-- Soru 2: ismi Kemal Yasa olan satırı siliniz
DELETE FROM ogrenciler WHERE isim = 'Kemal Yasa';

-- Soru 3: ismi Nesibe Yılmaz veya Mustafa Bak olan kayıtları silelim
DELETE FROM ogrenciler WHERE isim ='Nesibe Yilmaz' or isim = 'Mustafa Bak';

-- Soru 4: ismi Ali Can ve id'si 123 olan kaydı siliniz
...
-- Personel tablosunun adini işciler olarak degistiriniz
...
-- PRIMARY KEY --> Bir sutunun NULL icermemesini ve sutundaki verilerin BENZERSIZ olmasini saglar(NOT NULL _ UNIQUE)
...
-- NOT NULL kisitlamasi icin CONTRAINT ismi tanimlanmaz. Bu kisitlama veri turunden hemen sonra yerlestirilir

-- CHECK --> Bir sutuna yerlestiribilecek deger araligini sinirlamak icin kullanilir
